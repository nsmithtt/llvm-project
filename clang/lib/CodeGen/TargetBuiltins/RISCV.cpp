...
#define TT_BUILTIN(name) \
  ...
  TT_BUILTIN(mvmul_bh)
  TT_BUILTIN(elwmul_bh)
  TT_BUILTIN(elwadd_bh)
  TT_BUILTIN(elwsub_bh)
  TT_BUILTIN(movd2a_bh)
  TT_BUILTIN(movd2b_bh)
  TT_BUILTIN(mova2d_bh)
  TT_BUILTIN(movb2a_bh)
  TT_BUILTIN(sfpload_bh)
  TT_BUILTIN(sfpstore_bh)
  TT_BUILTIN(sfploadmacro_bh)
  ...
  TT_BUILTIN(mova2d)
  TT_BUILTIN(movb2d)
  TT_BUILTIN(trnspsrcb)
  TT_BUILTIN(shiftxa)
  TT_BUILTIN(shiftxb)
  TT_BUILTIN(clrexphist)
  TT_BUILTIN(gatesrcrst)
  TT_BUILTIN(cleardvalid)
  TT_BUILTIN(setrwc)
  TT_BUILTIN(incrwc)
  TT_BUILTIN(xmov)
  TT_BUILTIN(pacr)
  TT_BUILTIN(unpacr)
  TT_BUILTIN(unpacr_ctxinc)
  TT_BUILTIN(unpacr_flush)
  TT_BUILTIN(unpacr_nop)
  TT_BUILTIN(pacr_setreg)
  TT_BUILTIN(setdmareg)
  TT_BUILTIN(setdmareg_special)
  TT_BUILTIN(reg2flop)
  TT_BUILTIN(reg2flop_adc)
  TT_BUILTIN(loadind)
  TT_BUILTIN(setadc)
  TT_BUILTIN(setadcxy)
  TT_BUILTIN(incadcxy)
  ...
  TT_BUILTIN(incadczw)
  TT_BUILTIN(addrcrzw)
  TT_BUILTIN(setdvalid)
  TT_BUILTIN(setadcxx)
  TT_BUILTIN(adddmareg)
  TT_BUILTIN(adddmaregi)
  TT_BUILTIN(subdmareg)
  TT_BUILTIN(subdmaregi)
  TT_BUILTIN(muldmareg)
  TT_BUILTIN(muldmaregi)
  TT_BUILTIN(bitwopdmareg)
  TT_BUILTIN(bitwopdmaregi)
  TT_BUILTIN(shiftdmareg)
  TT_BUILTIN(shiftdmaregi)
  TT_BUILTIN(cmpdmareg)
  TT_BUILTIN(cmpdmaregi)
  TT_BUILTIN(flushdma)
  TT_BUILTIN(dmanop)
  TT_BUILTIN(atincget)
  TT_BUILTIN(atincgetptr)
  TT_BUILTIN(atswap)
  TT_BUILTIN(atcas)
  TT_BUILTIN(storeind_l1)
  TT_BUILTIN(storeind_src)
  TT_BUILTIN(storeind_mmio)
  TT_BUILTIN(storereg)
  TT_BUILTIN(loadreg)
  TT_BUILTIN(sfpload)
  TT_BUILTIN(sfploadi)
  ...
  TT_BUILTIN(sfpnot)
  TT_BUILTIN(sfplz)
  TT_BUILTIN(sfpsetexp)
  TT_BUILTIN(sfpsetman)
  TT_BUILTIN(sfpmad)
  TT_BUILTIN(sfpadd)
  TT_BUILTIN(sfpmul)
  TT_BUILTIN(sfppushc)
  TT_BUILTIN(sfppopc)
  TT_BUILTIN(sfpsetsgn)
  TT_BUILTIN(sfpencc)
  TT_BUILTIN(sfpcompc)
  TT_BUILTIN(sfptransp)
  TT_BUILTIN(sfpxor)
  TT_BUILTIN(sfpstochrnd)
  TT_BUILTIN(sfpstochrndi)
  TT_BUILTIN(sfpnop)
  TT_BUILTIN(sfpcast)
  TT_BUILTIN(sfpconfig)
  TT_BUILTIN(sfpswap)
  TT_BUILTIN(sfploadmacro)
  TT_BUILTIN(sfpshft2)
  TT_BUILTIN(sfpshft2i)
  TT_BUILTIN(sfplutfp32)
  TT_BUILTIN(atgetm)
  TT_BUILTIN(atrelm)
  TT_BUILTIN(stallwait)
  TT_BUILTIN(seminit)
  TT_BUILTIN(sempost)
  TT_BUILTIN(semget)
  TT_BUILTIN(semwait)
