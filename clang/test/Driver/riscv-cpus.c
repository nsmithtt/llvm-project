...
// RUN: %clang --target=riscv32 -### -c %s 2>&1 -mcpu=tt-wh-brisc | FileCheck -check-prefix=MCPU-TT-TENSIX-BRISC %s
// MCPU-TT-TENSIX-BRISC: "-target-cpu" "tt-wh-brisc"
...
// MCPU-TT-TENSIX-BRISC-SAME: "-target-feature" "+experimental-xttensixwh"
// MCPU-TT-TENSIX-BRISC-SAME: "-target-abi" "ilp32"

// RUN: %clang --target=riscv32 -### -c %s 2>&1 -mtune=tt-wh-brisc | FileCheck -check-prefix=MTUNE-TT-TENSIX-BRISC %s
// MTUNE-TT-TENSIX-BRISC: "-tune-cpu" "tt-wh-brisc"
